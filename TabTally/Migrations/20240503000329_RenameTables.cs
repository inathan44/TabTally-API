        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransactionDetail_Group_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Group",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupMember_InvitedById",
                table: "GroupMember",
                column: "InvitedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionDetail_GroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionDetail_RecipientId",
                table: "TransactionDetail",
                column: "RecipientId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransactionDetails_Group_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Group",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransactionDetails_User_PayerId",
                        column: x => x.PayerId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransactionDetails_User_RecipientId",
                        column: x => x.RecipientId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionDetails_GroupId",
                table: "TransactionDetails",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_TransactionDetails_PayerId",
                table: "TransactionDetails",
                column: "PayerId");

            migrationBuilder.CreateIndex(
                name: "IX_TransactionDetails_RecipientId",
                table: "TransactionDetails",
                column: "RecipientId");
